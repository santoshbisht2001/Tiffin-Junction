...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $validEmail = "example_merchant@example.com";
    $validPassword = "example_password";

    if ($email == $validEmail && $password == $validPassword) {
        echo "<p>Login successful! Welcome, Merchant!</p>";
    } else {
...
<body>
    ...
    <header>
        ...
        <a href="coustomerlogin.php">User Login</a>
    ...
    <div class="container">
        ...
        <form action="testmerchantserver.php" method="post">
        <h2 style="color:black">Merchant Login</h2>
